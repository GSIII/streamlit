...
image_files = [
    'https://github.com/GSIII/streamlit/blob/main/sidebar/data/Vermeer.png?raw=true',
    'https://github.com/GSIII/streamlit/blob/main/sidebar/data/Gogh.png?raw=true',
    'https://github.com/GSIII/streamlit/blob/main/sidebar/data/Munch.png?raw=true',
